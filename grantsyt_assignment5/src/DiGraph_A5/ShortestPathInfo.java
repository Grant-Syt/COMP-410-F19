...
public class ShortestPathInfo implements Comparable<ShortestPathInfo> {
/*
 * 
...
@Override
public int compareTo(ShortestPathInfo n) {
	if(this.getTotalWeight() > n.getTotalWeight()) {
        return 1;
    } else if (this.getTotalWeight() < n.getTotalWeight()) {
        return -1;
    } else {
        return 0;
    }
